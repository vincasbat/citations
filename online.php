...
$query2 = "INSERT INTO online (citation_id, text) VALUES".
" ('$citation_id', '$text')";    
$result = mysqli_query($cxn, $query2) or die ("Error: ".mysqli_error($cxn));


mysqli_close($cxn); 
//header("Location: sarasas.php");die();
...
<fieldset>
<legend>Online citavimas</legend>
...
<div>
	...
	<input type="text" name="text" size="70" value="<?php if(isset($_POST['text']))  echo $_POST['text']; ?>"   />
...
echo "&nbsp;&nbsp;<a href='online.php'>Išvalyti</a></p>\n";
