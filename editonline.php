...
if (strlen($text)<3) {$mess.="<br>Reikia įrašyti informaciją apie online citavimo šaltinį";}
...
$query2 = "UPDATE  online SET  text='$text' WHERE citation_id='$id'";
...
$sql = "SELECT * from citation, online WHERE citation.id = online.citation_id AND id='$id'"; 
...
<div>
	<label for='text'>Online <span style='color:red;'>*</span></label> 
	<input type="text" name="text" size="70" value="<?php if(isset($_POST['text']))  echo $_POST['text']; else echo $text;?>"   />
	<span style='color:LightGray;'>laisvas tekstas</span>
</div>
