...
$rel_passage = trim($_POST['rel-passage']);	
		//if(strlen($rel_passage)<3) {$mess.="<br>Reikia nurodyti rel-passage";}
...
$query2 = "UPDATE  article SET  autoriai='$autoriai', atl='$atl', refno='$refno', sertitle='$sertitle', imprint='$imprint', pubdate='$pubdate', notes='$notes', location='$location' WHERE citation_id='$id'";
...
$sql = "SELECT * from citation, article WHERE citation.id = article.citation_id AND id='$id'"; 
...
<div>
	...
	<input id="atr" type="text" name="autoriai" size="50" value="<?php if(isset($_POST['autoriai']))  echo $_POST['autoriai']; else echo $autoriai; ?>"   />
	<span style='color:LightGray;'>K. Kieu et al</span>
</div>
<div>   <label for='atl'>Straipsnio pav. <span style='color:red;'>*</span></label> 
	<input type="text" name="atl" size="50"  value="<?php if(isset($_POST['atl']))  echo $_POST['atl']; else echo $atl; ?>"   />	
</div>
...
<div>   <label for='sertitle'>Leidinio pav.<span style='color:red;'>*</span></label> 
	<input type="text" name="sertitle" size="50"  value="<?php if(isset($_POST['sertitle']))  echo $_POST['sertitle']; else echo $sertitle; ?>"   />
...
<div>   <label for='pubdate'>Leidimo data</label> 
	<input type="text" name="pubdate" size="50"  value="<?php if(isset($_POST['pubdate']))  echo $_POST['pubdate']; else echo $pubdate; ?>"   />
...
<div>   <label for='notes'>Pastabos</label> 
	<input type="text" name="notes" size="50"  value="<?php if(isset($_POST['notes']))  echo $_POST['notes'];  else echo $notes; ?>"   />
